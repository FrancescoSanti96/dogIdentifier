#!/usr/bin/env python3
"""
Quick training con 90 razze e TensorBoard integrato (estende i quick60)
...
def quick90_tensorboard_train():
    print("🚀 QUICK 90 BREEDS + TENSORBOARD")
    print("=================================")
    print("📊 Training con 90 razze e monitoring TensorBoard")
    ...
    tb_logdir = f"outputs/tensorboard/quick90_{timestamp}"
    ...
    # Config
    data_dir = os.getenv("SPLITS_DIR", "data/top90_balanced")
    num_epochs = int(os.getenv("EPOCHS", "30"))
    ...
    print("\n" + "=" * 60)
    print("🚀 STARTING QUICK 90 BREEDS TRAINING")
    print("=" * 60)
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_val_acc:
            ...
            os.makedirs("outputs/top90", exist_ok=True)
            torch.save(
                {
...
if __name__ == "__main__":
    results = quick90_tensorboard_train()
