#!/usr/bin/env python3
"""
Quick training con 60 razze e TensorBoard integrato (estende i quick30)
...
def quick60_tensorboard_train():
    print("🚀 QUICK 60 BREEDS + TENSORBOARD")
    print("=================================")
    print("📊 Training con 60 razze e monitoring TensorBoard")
    ...
    tb_logdir = f"outputs/tensorboard/quick60_{timestamp}"
    ...
    # Config
    data_dir = os.getenv("SPLITS_DIR", "data/top60_balanced")
    ...
    print("\n" + "=" * 60)
    print("🚀 STARTING QUICK 60 BREEDS TRAINING")
    print("=" * 60)
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_val_acc:
            ...
            os.makedirs("outputs/top60", exist_ok=True)
            torch.save(
                {
...
if __name__ == "__main__":
    results = quick60_tensorboard_train()
